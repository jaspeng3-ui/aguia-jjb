  ...
  return<div style={S.grid}>
    ...
    <div style={{...crd,borderLeft:`3px solid ${C.blueLight}`,padding:18}}>
      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}>
        ...
        <div><h3 style={{...hd,fontSize:20,color:C.blueLight}}>Assistant IA</h3><p style={{fontSize:12,color:C.textMuted}}>Génération de textes via Gemini (Google) — gratuit</p></div>
      </div>
